...
{
    [CarteiraCodigo("26")]
    internal class BancoBradescoCarteira26 : ICarteira<BancoBradesco>
    {
        internal static Lazy<ICarteira<BancoBradesco>> Instance { get; } = new Lazy<ICarteira<BancoBradesco>>(() => new BancoBradescoCarteira26());

        private BancoBradescoCarteira26()
        {
